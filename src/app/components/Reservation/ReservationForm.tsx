    ...
    <div className='bg-green-700 p-6 rounded-lg'>
        ...
        <div className='mt-[2rem]'>
            <div className='flex flex-col sm:flex-row space-y-3 sm:space-y-0 items-center w-[80%] mx-auto justify-between space-x-4'>
                ...
                <input type='date' className='px-10 py-2.5 bg-transparent rounded-lg outline-none text-[17px] text-white border-[2.2px] border-gray-100' name='' id="" />
            </div>
            <input type='time' className='px-10 py-2.5 bg-transparent block w-[80%] mx-auto mt-[1rem] rounded-lg outline-none text-[17px] font-bold text-white border-[2.2px] border-gray-100'/>
