...
const MobileNav = ({closeNav, showNav}: Props) => {
  ...
  return (
    <div className={`fixed ${navStyle} right-0 transition-all duration-500 left-0 top-0 bottom-0 h-[100vh bg-slate-600 z-[1002]`}>
        ...
        <ul className='space-y-10'>
                <li className='text-[35px] flex items-center font-medium hover:text-yellow-600 text-white'>
                    <Link href="/">Home</Link>
                </li>
                <li className='text-[35px] flex items-center font-medium hover:text-yellow-600 text-white'>
                    <Link href="/">Shop</Link>
